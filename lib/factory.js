...
prototype.normalizeDescriptors = function (descriptors) {
  ...
  each(descriptors, function (descriptor, name) {
    normalized[name] = self.normalizeDescriptor(descriptor);
  });
  return normalized;
};
 ...
 */
prototype.normalizeDescriptor = function (descriptor) {
  var normalized = {},
      self = this;
  ...
  if (normalized.value === undefined && normalized.get === undefined && normalized.set === undefined) {
...
prototype.createInitialize = function (Class, descriptors) {
  return this.createDynamicFunction('');
};
...
prototype.createToJSON = function (Class, descriptors) {
  ...
  return this.createDynamicFunction('return {\n  ' + body.join(',\n  ') + '};\n');
};
...
prototype.createStaticDefineProperty = function (Class, descriptors, staticDescriptors) {
  ...
  return function defineProperty (name, descriptor) {
    this['[[descriptors]]'][name] = factory.normalizeDescriptor(descriptor);
